...
const PostSection = () => {
  const [posts, setPosts] = useState([
    //  posts data 
    {
      ...
      timeAgo: '5d',
      image: "https://rukminim2.flixcart.com/image/850/1000/poster/e/k/u/akhuratha-poster-movie-priest-hd-wallpaper-background-akmov3900-original-imaek7n4hfdnfdmw.jpeg?q=90&crop=false" // Dynamic image URL for each post
    },
    
  {
    ...
    timeAgo: '',
    image: 'https://cma-wp-media.s3.ca-central-1.amazonaws.com/wp-content/uploads/2020/04/29125905/Impact-of-Remote-Working-in-Real-Estate-1024x634.jpg' // Dynamic image URL for each post
  },
  {
    id: 3,
    name: 'TARUN SAI 2030',
...
5. Listen more than you talk and be teachable.`,
    ...
    timeAgo: 'Jan 30',
    image: 'https://indianexpress.com/wp-content/uploads/2024/11/2_a529b2.jpg' // Dynamic image URL for each post
  },
  {
    id:4 ,
    name: 'Perdeep Kumar',
    ...
    title: "How is Mumbai University's CSE better than other private universities in India?",
    ...
    timeAgo: 'Dec 24',
    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTp010DlCEi9yzAeFbo16n1YmU5IuNN5iaSQQ&s' // Dynamic image URL for each post
  },
  ]);
